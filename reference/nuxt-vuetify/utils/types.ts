...
export interface CabinetSpec { w: number; h: number; d: number; base: number; label: string; }
export interface PanelElement { id: number; type: ElementType; x: number; y: number; w: number; h: number; diameter?: number; }

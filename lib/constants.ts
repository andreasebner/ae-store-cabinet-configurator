...
export const CABINETS: Record<CabinetKey, CabinetSpec> = {
  compact: {
    name: 'ARLI 1060 — Compact',
    w: 600, h: 380, d: 210,
    basePrice: 320,
    description: 'IP65 ABS plastic enclosure with transparent door. Halogen-free, impact-resistant (IK10). Includes galvanized mounting plate.',
  ...
  standard: {
    name: 'ARLI 1076 — Standard',
    w: 760, h: 500, d: 300,
    basePrice: 480,
    description: 'Versatile IP65 control cabinet in halogen-free ABS. Transparent door with perimeter seal, galvanized steel mounting plate, and dual locking mechanism.',
    modelUrl: '/assets/cabinets/default/model.glb',
    bodyCenter: [0, 0, 0],
    defaultFace: 'right',
    disabledSides: ['back'],
  ...
  large: {
    name: 'ARLI 1114 — Large',
    w: 1000, h: 600, d: 400,
    basePrice: 720,
    description: 'Spacious IP65 enclosure for complex installations. Resistant to chemicals, alkalis, oils and salts. Operating range −35 °C to +65 °C.',
    modelUrl: '/assets/cabinets/default/model.glb',
    bodyCenter: [0, 0, 0],
    defaultFace: 'right',
    disabledSides: ['back'],
  ...
  industrial: {
    name: 'ARLI 1180 — Industrial',
    w: 1200, h: 800, d: 500,
    basePrice: 1100,
    description: 'Heavy-duty IP65 industrial cabinet in impact-resistant ABS. Dual-locking with key, galvanized mounting plate, wall-mount brackets and full seal included.',
    modelUrl: '/assets/cabinets/default/model.glb',
    bodyCenter: [0, 0, 0],
    defaultFace: 'right',
    disabledSides: ['back'],

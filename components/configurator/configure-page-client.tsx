...
import { CABINET_KEYS, CABINETS, SIDES, calcPrice, getPanelDimensions, COMPONENT_CATALOG, SHAPE_CATALOG } from '@/lib/constants';
        ...
        <div className="w-1/3 flex flex-col border-r border-slate-200 min-h-0 overflow-hidden">
          ...
          <div className="px-4 py-2 bg-white border-t border-slate-200 shrink-0">
            <div className="flex gap-1 justify-center">
              {SIDES.filter(side => !(CABINETS[currentCabinet].disabledSides ?? []).includes(side)).map(side => {
